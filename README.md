# Build An Alexa Calculator Skill
...
This Alexa sample skill is a template for a basic calculator skill. Provide two number and an operation and Alexa will do the math for you.
...
1. Clone the repository.
	...
	```bash
	$ git clone https://github.com/germanviscuso/skill-sample-nodejs-mycalculator
	```

2. Navigating into the repository's root folder.

	```bash
	$ cd skill-sample-nodejs-mycalculator
	```
...
2. Simulate verbal interaction with your skill through the command line using the following example:
	...
	```bash
	 $ ask simulate -l en-US -t "start my calculator"
